...
if [[ $1 == "float-scaled" ]]; then
	if [[ ${basefilenoext,,} == "zzzsplore" ]]; then
		/$directory/pico-8/pico8_dyn -splore -home /$directory/pico-8/ -root_path /$directory/pico-8/carts/ -joystick 0
	else
		/$directory/pico-8/pico8_dyn -home /$directory/pico-8/ -root_path /$directory/pico-8/carts/ -joystick 0 -run "$2"
	fi
elif [[ $1 == "pixel-perfect" ]]; then
	if [[ ${basefilenoext,,} == "zzzsplore" ]]; then
		/$directory/pico-8/pico8_dyn -splore -home /$directory/pico-8/ -root_path /$directory/pico-8/carts/ -joystick 0 -pixel_perfect 1
	else
		/$directory/pico-8/pico8_dyn -home /$directory/pico-8/ -root_path /$directory/pico-8/carts/ -joystick 0 -pixel_perfect 1 -run "$2"
	fi
else
	if [[ ${basefilenoext,,} == "zzzsplore" ]]; then
		/$directory/pico-8/pico8_dyn -splore -home /$directory/pico-8/ -root_path /$directory/pico-8/carts/ -joystick 0 -draw_rect 0,0,480,320
	else
		/$directory/pico-8/pico8_dyn -home /$directory/pico-8/ -root_path /$directory/pico-8/carts/ -joystick 0 -draw_rect 0,0,480,320 -run "$2"
	fi
fi
